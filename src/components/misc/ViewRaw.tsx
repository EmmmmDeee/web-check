...
interface Props {
  everything: { id: string; result: any }[];
}

export const ViewRaw: React.FC<Props> = (props) => {
  ...
  return (
    <CardStyles>
      <div className="controls">
        ...
        <Button onClick={fetchResultsUrl} disabled={resultUrl ? true : false}>
      ...
      <small>
        These are the raw results generated from your URL, and in JSON format. You can
        import these into your own program, for further analysis.
      </small>
    </CardStyles>
  );
};
